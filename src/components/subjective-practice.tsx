    ...
    return (
      <div className="vsv-enter rounded-lg border-2 border-leaf-500/50 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mx-auto mt-2 max-w-md text-[15px] text-slate-600">
          <T>
            Your drafted answers were saved. Cross-check them with each scoring key below
            (or download the full scheme for classroom evaluation with your teacher).
          </T>
        </p>
        <div className="mt-4 flex justify-center">
          ...
          >
            ...
            {done.xpEarned > 0
              ? t("+{xp} XP for completing the chapter's subjective set", {
                  xp: done.xpEarned,
                })
              : t(
                ...
                return (
                  <li key={q.id} className="rounded-lg border border-line bg-white p-4 shadow-sm">
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder={t("Draft your answer here (optional — you can also write on paper).")}
