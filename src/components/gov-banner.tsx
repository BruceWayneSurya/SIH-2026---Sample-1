...
/**
 * Official identification strip shown above the portal navigation — the
 * standard Government of India masthead: State chakra, bilingual
 * भारत सरकार / Government of India lockup, ministry attribution, helpline
 * and the GIGW accessibility toolbar (text size + high contrast).
 */
    ...
    <div className="border-b border-line bg-white">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-4 gap-y-1.5 px-4 py-2">
        <span className="flex items-center gap-2.5">
          <ChakraMark className="h-9 w-9 text-navy-800 dark:text-saffron-400" />
          <span className="leading-tight">
            <span
              className="block text-[15px] font-extrabold text-navy-900 dark:text-white"
              lang="hi"
              style={{ fontFamily: "var(--font-deva), serif" }}
            >
              भारत सरकार
            </span>
            <span className="block text-[11px] font-bold uppercase tracking-[0.18em] text-navy-700 dark:text-navy-200">
        ...
        <span className="ml-auto flex flex-wrap items-center justify-end gap-x-3 gap-y-1.5">
          <A11yToolbar compact />
          <span className="hidden items-center gap-1.5 text-[12px] font-semibold text-slate-600 dark:text-navy-200 lg:inline-flex">
