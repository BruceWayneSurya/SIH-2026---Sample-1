  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <p className="mt-3 text-[15px] leading-relaxed text-slate-600">
        ...
        <T>
          Every chapter carries NCERT learning-outcome IDs and a DIKSHA course code so
          that teaching, practice and reporting can be audited against the national
      ...
      >
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-[15px] text-slate-700">
          <li>
            <T>
              A teacher signs in or registers with the email ID issued by the school or
              department.
            </T>
          </li>
          <li>
            <T>
              A six-digit one-time code is sent to that mailbox. The code is valid for ten
              minutes, may be attempted five times and is never stored in plain form.
            </T>
          </li>
          <li>
            <T>
            ...
            <T>
              as soon as the mailbox is confirmed, which unlocks verification of community
              notes.
            </T>
          </li>
          <li>
            <T>
              Personal mailboxes (Gmail and similar) are accepted with review: the mailbox
              is confirmed, but a verified reviewer must confirm the institution before
              moderation rights are granted.
            </T>
          </li>
        </ol>
        <p className="mt-3 inline-flex items-center gap-2 rounded-md border border-leaf-500/40 bg-leaf-50 px-3 py-2 text-[13px] font-bold text-leaf-700">
          ...
          <T>
            Verification is mandatory — an unverified account cannot publish a verified
            note.
          </T>
        </p>
      </section>
      ...
      >
        ...
        <p className="mt-2 text-[15px] leading-relaxed text-slate-600">
          <T>
            The interface targets WCAG 2.1 AA: keyboard-navigable controls, visible focus,
            sufficient contrast, a dark theme, adjustable interface language (English,
            हिन्दी, తెలుగు, தமிழ், ಕನ್ನಡ, മലയാളം) and a data saver mode for
            low-bandwidth connections. Report a barrier on the helpline above and it will
